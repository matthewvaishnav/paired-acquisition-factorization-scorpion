...
from src.models.scorpion_paired_acquisition import (
    ProjectionConfig,
    ScorpionProjection,
    projection_loss,
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--methods",
        nargs="+",
        choices=("paired_consistency", "paired_acquisition"),
        default=("paired_consistency", "paired_acquisition"),
    )
    ...
    print("SCORPION PAIRED-ACQUISITION NEURAL FACTORIZATION PROJECTION TRAINING PASSED")
...
if __name__ == "__main__":
    try:
        ...
        print(f"SCORPION PAIRED-ACQUISITION NEURAL FACTORIZATION TRAINING FAILED: {exc}", file=sys.stderr)
